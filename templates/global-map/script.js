...
// Updated projection:
// - Slightly smaller scale to reduce the visual weight of the far north
// - Shifted upward because Antarctica is removed
...
Promise.all([
  ...
  // Remove Antarctica and disputed / unwanted geographies
  geoData.features = geoData.features.filter(d => {
    ...
    return !names.includes("Antarctica") &&
           !names.includes("Western Sahara") &&
